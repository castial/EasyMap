...
@property (nonatomic, readonly) NSString *year; ///< Year component
@property (nonatomic, readonly) NSString *month; ///< Month component (1~12)
@property (nonatomic, readonly) NSString *day; ///< Day component (1~31)
